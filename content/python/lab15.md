...
Во-вторых, ииногда бывает, что просто надо ускорить именно питонское. Стек у вас такой, или ТЗ, или просто хочется повыделываться --- выбирайте сами.
...
### 5. [**Cython**](https://cython.readthedocs.io/en/latest/index.html)

Объяснить что такое [Cython](https://cython.readthedocs.io/en/latest/src/quickstart/overview.html) проще всего так:
