...
### Функции для подключения к C коду

Теперь подружим ассемблер с C - напишем код, который вычисляет то же самое, но полученный объектный файл будет содержать функцию, пригодную для вызова из C.
